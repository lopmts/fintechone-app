...
export type TransactionOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "userId" | "accountId" | "categoryId" | "description" | "amount" | "type" | "date" | "createdAt" | "updatedAt", ExtArgs["result"]["transaction"]>;
