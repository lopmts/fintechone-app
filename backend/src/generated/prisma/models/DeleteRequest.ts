...
// @ts-nocheck 
/*
 * This file exports the `DeleteRequest` model and its related types.
 *
...
export type GetDeleteRequestAggregateType<T extends DeleteRequestAggregateArgs> = {
    ...
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateDeleteRequest[P]>
    : Prisma.GetScalarType<T[P], AggregateDeleteRequest[P]>
}
...
type GetDeleteRequestGroupByPayload<T extends DeleteRequestGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<DeleteRequestGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof DeleteRequestGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], DeleteRequestGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], DeleteRequestGroupByOutputType[P]>
      }
    >
  >
...
export type DeleteRequestCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
...
export interface DeleteRequestDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  **/
  count<T extends DeleteRequestCountArgs>(
    args?: Prisma.Subset<T, DeleteRequestCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], DeleteRequestCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, DeleteRequestGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetDeleteRequestGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
