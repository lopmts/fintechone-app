...
// @ts-nocheck 
/*
 * This file exports the `InstallmentsPaid` model and its related types.
 *
...
export type GetInstallmentsPaidAggregateType<T extends InstallmentsPaidAggregateArgs> = {
      [P in keyof T & keyof AggregateInstallmentsPaid]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateInstallmentsPaid[P]>
    : Prisma.GetScalarType<T[P], AggregateInstallmentsPaid[P]>
}
...
type GetInstallmentsPaidGroupByPayload<T extends InstallmentsPaidGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<InstallmentsPaidGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof InstallmentsPaidGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], InstallmentsPaidGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], InstallmentsPaidGroupByOutputType[P]>
      }
    >
  >
...
export type InstallmentsPaidCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<InstallmentsPaidFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface InstallmentsPaidDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['InstallmentsPaid'], meta: { name: 'InstallmentsPaid' } }
  /**
   ...
   * })
  **/
  count<T extends InstallmentsPaidCountArgs>(
    args?: Prisma.Subset<T, InstallmentsPaidCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], InstallmentsPaidCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends InstallmentsPaidGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, InstallmentsPaidGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetInstallmentsPaidGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
